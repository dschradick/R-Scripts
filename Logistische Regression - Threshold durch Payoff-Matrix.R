...
#### Threshold bestimmen mit Payoff
...
#    welcher sowieso wiederkommt führt zu einem Verlust von durschschnittlich $15
# 3. Vorhersage, dass Customer zurückommmt erzeugt keine direkten Kosten
#
